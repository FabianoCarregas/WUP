...
def run(email, password, url):
    ...
    driver.find_element(By.ID, 'headerBusca-campoBusca').send_keys('Clojure: all about Collections')
    ...
    time.sleep(2)
    driver.get('https://courses.alura.online/course/clojure-collections/task/132')
    time.sleep(2)
    ...
    driver.get(e_url)
    driver.find_element(By.CLASS_NAME, 'headerBusca-icon-svg').click()
    driver.find_element(By.ID, 'headerBusca-campoBusca').send_keys('>>>>>>>- ALURA-ONLINE WARMED UP -<<<<<<<  :)')
