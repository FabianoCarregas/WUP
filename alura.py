...
def log_in(email, password, url):
    ...
    driver.find_element(By.ID, 'headerBusca-campoBusca').send_keys('Curso PNL: comunicação efetiva para o dia a dia')
    ...
    time.sleep(2)
    driver.get('https://cursos.alura.com.br/course/pnl-comunicacao-efetiva/task/76672')
    time.sleep(2)
